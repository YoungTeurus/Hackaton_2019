...
#define EXIT_LEFT true, false, true, false, 3 // Object, повЄрнутый вправо, не нужно вращать, проходимый, не толкаемый, перемещает игрока в другую комнату влево
...
#define TEST_ACTOR 50, 50, 7 // Actor, проходимый, не толкаемый. –азмеры: (50,50)